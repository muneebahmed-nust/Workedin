...
class EnglishInterface:
    ...
    def signup_page(self):
        ...
        age_label.place(relx=0.4, rely=.2, anchor="e")
        ...
        confirm_password_label.place(relx=0.55, rely=0.45, anchor="e")
        
        confirm_password_entry = ctk.CTkEntry(frame, width=200, height=30, show="*")
        confirm_password_entry.place(relx=0.55, rely=0.7, anchor="w")

        city_label=ctk.CTkLabel(frame,text="City:",font=self.label_data_font)
        city_label.place(relx=0.4, rely=0.6, anchor="e")
        ...
        city_box.place(relx=0.6, rely=0.6, anchor="w")
        signup_button = ctk.CTkButton(frame, text="Sign Up", width=120, height=32, command=lambda:self.app.show_page(self.labour_data_entry_page))
    ...
    def labour_data_entry_page(self):
        ...
        tradesperson_data_entry_label=ctk.CTkLabel(frame,text="Workedin",font=self.heading_label_font )
